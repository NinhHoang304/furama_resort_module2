...
public class Villa extends Facility{
    ...
    public Villa(String idFacility, String nameService, double usableArea,
                 double rentCost, int maximumPeople, String rentTypes, String roomTypes, double poolArea, int floor) {
